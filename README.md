...
| Tool | Description |
|:-----|:------------|
| 📱 **QR Code Generator & Scanner** | Generate custom QR codes (URL, Wi-Fi, vCard) with colors/sizes, export PNG/SVG, & decode QR from images |
